...
class RecipeTest < ActiveSupport::TestCase
  ...
  test "Should not save without a recipe title" do
    recipe = Recipe.new(body: @recipe.body, featured_image: @recipe.featured_image, video_url: @recipe.video_url, ingredients_attributes: [
  ...
  test "Should not save without a recipe body" do
    recipe = Recipe.new(featured_image: @recipe.featured_image, title: @recipe.title, video_url: @recipe.video_url, ingredients_attributes: [
      { content: @ingredient_one.content },
      { content: @ingredient_two.content }
    ]
    )
  ...
  test "Should save without any video url " do
    recipe = Recipe.new(body: @recipe.body, featured_image: @recipe.featured_image, title: @recipe.title, ingredients_attributes: [
      { content: @ingredient_one.content },
      { content: @ingredient_two.content }
    ]
    )
  ...
  test "Should save video with valid video url " do
    recipe = Recipe.new(body: @recipe.body, featured_image: @recipe.featured_image, title: @recipe.title, video_url: @recipe.video_url, ingredients_attributes: [
      { content: @ingredient_one.content },
      { content: @ingredient_two.content }
    ]
    )
  ...
  test "Should not save without featured image" do
    recipe = Recipe.new(body: @recipe.body, video_url: @recipe.video_url, title: @recipe.title, ingredients_attributes: [
      { content: @ingredient_one.content },
      { content: @ingredient_two.content }
    ]
    )
  ...
  test "Should not save without any ingredient" do
    recipe = Recipe.new(body: @recipe.body, featured_image: @recipe.featured_image, video_url: @recipe.video_url, title: @recipe.title)
